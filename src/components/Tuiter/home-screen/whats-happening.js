    ...
    return (
        <>
            <div className="pt-2 row">
                <div className="col-1">
                    <img className="wd-rounded-corners" height="50" width="50" src="../../../images/node.png"/>
                </div>
                <div className="col-9">
                    <textarea className="form-control w-75 bg-black text-white ms-3 w-100 wd-search-area" onChange={(e) => setNewTuit({...newTuit, tuit: e.target.value})}/>
